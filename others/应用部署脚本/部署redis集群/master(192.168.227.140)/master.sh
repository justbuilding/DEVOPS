...
ssh root@192.168.227.141 /root/create_redis_cluster.sh
ssh root@192.168.227.139 /root/create_redis_cluster.sh


info="集群名称：${clustername}  |哨兵：192.168.227.140 ${sentinel_port}, 192.168.227.141 ${sentinel_port}, 192.168.227.139 ${sentinel_port} |口令：123456"
